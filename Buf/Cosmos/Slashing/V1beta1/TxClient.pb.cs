...
namespace Cosmos.Slashing.V1beta1 {
	...
	public class MsgClient {
        ...
        /// <summary>
      	/// SendMsgUnjail sends a MsgUnjail transaction to the blockchain and waits
      	/// for a response.
      	/// </summary>
      	/// <param name="msg">The MsgUnjail message that should be send.</param>
      	/// <param name="fee">The fees that will be paid.</param>
        [global::System.CodeDom.Compiler.GeneratedCode("protoc-gen-cosmos-csharp", null)]
        public Task<Cosmcs.Client.ClientResponse<MsgUnjailResponse>> SendMsgUnjail(MsgUnjail msg, Cosmcs.Tx.Fee? fee = null) {
			...
			.ContinueWith(r => new Cosmcs.Client.ClientResponse<MsgUnjailResponse>(
				r.Result,
				MsgUnjailResponse.Parser
			));
		}

		/// <summary>
      	/// SimulateMsgUnjail simulates a MsgUnjail transaction on the blockchain.
      	/// </summary>
      	/// <param name="msg">The MsgUnjail message that should be simulated.</param>
		[global::System.CodeDom.Compiler.GeneratedCode("protoc-gen-cosmos-csharp", null)]
		public Task<Cosmos.Tx.V1beta1.SimulateResponse> SimulateMsgUnjail(MsgUnjail msg) {
		...
		/// <summary>
      	/// SimulateAndSendMsgUnjail simulates, estimates fees and then sends a Unjail transaction to the blockchain.
      	/// </summary>
      	/// <param name="msg">The MsgUnjail message that should be send.</param>
		[global::System.CodeDom.Compiler.GeneratedCode("protoc-gen-cosmos-csharp", null)]
		public Task<Cosmcs.Client.ClientResponse<MsgUnjailResponse>> SimulateAndSendMsgUnjail(MsgUnjail msg) {
