...
namespace Cosmos.Evidence.V1beta1 {
	...
	public class MsgClient {
        ...
        public Task<Cosmcs.Client.ClientResponse<Cosmos.Evidence.V1beta1.MsgSubmitEvidenceResponse>> SendMsgSubmitEvidence(Cosmos.Evidence.V1beta1.MsgSubmitEvidence msg, Fee? fee = null) {
		...
		public Task<Cosmcs.Client.ClientResponse<Cosmos.Evidence.V1beta1.MsgSubmitEvidenceResponse>> SimulateAndSendMsgSubmitEvidence(Cosmos.Evidence.V1beta1.MsgSubmitEvidence msg) {
			return SimulateMsgSubmitEvidence(msg).ContinueWith(r => {
				return SendMsgSubmitEvidence(msg, new Fee((ulong) Math.Ceiling(r.Result.GasInfo.GasUsed * 1.5))).Result;
			});
		}
